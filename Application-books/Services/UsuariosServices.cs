...
namespace Application_books.Services
{
    public class UsuariosServices : IUsuariosServices
    {
        ...
        //    var usuariosEntity = await _booksContext.Usuarios(id).ToListAsync();
        ...
        {
            var UsuarioEntity = _mapper.Map<UserEntity>(dto);
        ...
        //{
        //    var usuarioEntity = await _booksContext.Usuarios.FirstOrDefaultAsync(e => e.Id == id);
        ...
        //        };
        //    }
        //    _mapper.Map<UsuarioEditDto, UserEntity>(dto, usuarioEntity);
        ...
        //{
        //    var usuarioEntity = await _booksContext.Usuarios.FirstOrDefaultAsync(x => x.Id == id);
